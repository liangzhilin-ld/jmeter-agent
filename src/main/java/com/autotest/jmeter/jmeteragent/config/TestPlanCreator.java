...
public class TestPlanCreator {
    ...
    public TestPlanCreator(JmeterProperties jmeterProperties, String jsonString) throws URISyntaxException {
        this.jmeterProperties = jmeterProperties;
        this.jsonString = jsonString;
//        this.initParam();
    }
    public TestPlanCreator(String jsonString) throws URISyntaxException {
        this.jsonString = jsonString;
       // this.initParam();
    } 
    ...
    public HashTree create() {
        ...
        Map<String, String> headerMap=new HashMap<String, String>() {
			...
			{
                put("Referer", "http://172.16.206.69:6600/");
                put("Accept-Language", "zh-CN,zh;q=0.9");
                put("Origin", "http://172.16.206.69:6600");

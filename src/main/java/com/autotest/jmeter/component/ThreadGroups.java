...
public class ThreadGroups {
     ...
     * @return
     */
    public static ThreadGroup create(TheadGroupEntity tgentity) {
...
//        threadGroup.setRampUp(5);        
        ...
        threadGroup.setScheduler(tgentity.getScheduler());//调度器
        threadGroup.setProperty(ThreadGroup.DURATION, tgentity.getDuration());//持续时间${__P(duration,20)}

        threadGroup.setProperty(ThreadGroup.DELAYED_START, tgentity.getDelayThredCreation(), false);//延时开启
...
//        threadGroup.setProperty(new TestElementProperty("Arguments", value)) ;    
    ...
    public static TheadGroupConfig theadGroupConfig() {

 ...
 * TechstarHTTPSamplerProxy.
 */
public final class TechstarHTTPSamplerProxy extends HTTPSamplerBase implements Interruptible {

	private static final long serialVersionUID = 1L;

	private transient HTTPAbstractImpl impl;

	public TechstarHTTPSamplerProxy() {
		super();
	}
	 ...
	 */
	public TechstarHTTPSamplerProxy(String impl) {
		super();
	...
	protected HTTPSampleResult sample(URL u, String method, boolean areFollowingRedirect, int depth) {
		...
		// testIterationStart will not be executed but it's not a problem for 51380 as
		// it's download of resources
...
//		System.out.println(impl.sample(u, method, areFollowingRedirect, depth).getResponseDataAsString());
	...
	// class.
	// This is because Config items are not processed until later, and HTTPDefaults
	// may define the implementation
	 ...
	 * 
	 * @see
	 * org.apache.jmeter.protocol.http.sampler.HTTPSamplerBase#testIterationStart(
